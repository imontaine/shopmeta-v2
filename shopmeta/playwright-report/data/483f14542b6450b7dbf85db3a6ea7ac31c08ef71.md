...
- Name: layout.spec.ts >> Layout — Desktop (1440px) >> authenticated user sees sidebar on desktop
- Location: tests\e2e\layout.spec.ts:48:3
...
- textbox "Email address":
  ...
  - text: layout-e2e-1782459665771-1@test.com
- text: Password
- textbox "Password":
